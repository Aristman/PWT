...
val primaryLightColor = Color(0xFFff79ff)
val primaryDarkColor = Color(0xFFaa00c7)
val secondaryColor = Color(0xFF90a4ae)
val secondaryLightColor = Color(0xFFc1d5e0)
...
val surfaceLightColor = Color(0xFFf3e5f5)
val onSurfaceLightColor = Color(0xFF000000)
val surfaceDarkColor = Color(0xFFc0b3c2)
